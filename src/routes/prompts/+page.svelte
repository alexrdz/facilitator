<script lang="ts">
        import { achievements, reflections, type Achievement, type Reflection } from '$lib/stores';
        ...
        function handleReflectionToggle(reflectionId: string) {
                if (selectedReflections.includes(reflectionId)) {
                        selectedReflections = selectedReflections.filter(id => id !== reflectionId);
                } else {
...
<div class="card">
                        ...
                        <div style="max-height: 300px; overflow-y: auto; border: 1px solid var(--color-border); border-radius: var(--radius-md); padding: var(--spacing-md); background-color: var(--color-surface)">
                                {#if achievementList.length === 0}
                                        <div style="text-align: center; padding: var(--spacing-2xl); color: var(--color-text-secondary)">
                                                <p>No accomplishments found. <a href="/hype" style="color: var(--color-primary)">Add some Hype Docs</a> first!</p>
                                        </div>
                                {:else}
                                        {#each achievementList as achievement}
                                                <div style="display: flex; align-items: flex-start; gap: var(--spacing-sm); padding: var(--spacing-sm); border-radius: var(--radius-sm); margin-bottom: var(--spacing-sm); cursor: pointer" class:hover-bg={true}>
                                                        ...
                                                        />
                                                        <label for="achievement-{achievement.id}" style="cursor: pointer; flex: 1">
                ...
                <div>
                        ...
                        <div style="max-height: 300px; overflow-y: auto; border: 1px solid var(--color-border); border-radius: var(--radius-md); padding: var(--spacing-md); background-color: var(--color-surface)">
                                {#if reflectionList.length === 0}
                                        <div style="text-align: center; padding: var(--spacing-2xl); color: var(--color-text-secondary)">
                                                <p>No reflections found. <a href="/reflection" style="color: var(--color-primary)">Add some reflections</a> first!</p>
                                        </div>
                                {:else}
                                        {#each reflectionList as reflection}
                                                <div style="display: flex; align-items: flex-start; gap: var(--spacing-sm); padding: var(--spacing-sm); border-radius: var(--radius-sm); margin-bottom: var(--spacing-sm); cursor: pointer" class:hover-bg={true}>
                                                        <input 
                                                                ...
                                                                style="margin-top: var(--spacing-xs)"
                                                        />
                                                        <label for="reflection-{reflection.id}" style="cursor: pointer; flex: 1">
        ...
        <div style="margin-bottom: var(--spacing-xl)">
                ...
                <div style="display: flex; gap: var(--spacing-md); flex-wrap: wrap">
                        <button 
                                ...
                                disabled={selectedAchievements.length === 0 && selectedReflections.length === 0}
                        >
                                Performance Review
                        </button>
                        <button 
        ...
        {#if showPrompt}
                <div style="background-color: var(--color-background); border: 1px solid var(--color-border); border-radius: var(--radius-md); padding: var(--spacing-lg); margin-top: var(--spacing-xl)">
                        ...
                        <div style="background-color: var(--color-surface); border-radius: var(--radius-sm); padding: var(--spacing-md); font-family: monospace; font-size: var(--font-size-sm); line-height: 1.5; white-space: pre-wrap; max-height: 400px; overflow-y: auto">
                                {generatedPrompt}
                        </div>
                        <div style="margin-top: var(--spacing-md); padding: var(--spacing-sm); background-color: var(--color-muted); border-radius: var(--radius-sm); font-size: var(--font-size-sm); color: var(--color-text-secondary); display: flex; align-items: center; gap: var(--spacing-xs)">
